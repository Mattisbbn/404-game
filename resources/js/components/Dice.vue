<template>
    <div class="dice-container">
        <div class="scene">
            <div class="cube" :class="{ 'cube-rolling': isRolling }" :style="{ transform: cubeTransform }">
                ...
                <div class="face face-6">
                    <img v-if="advancedCyberRisk" :src="advancedCyberRisk" class="custom-img"
